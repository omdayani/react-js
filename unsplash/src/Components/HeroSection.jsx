      ...
      <section className="flex items-end justify-center w-full ">
        ...
        <div className="w-1/2 border border-[#767676]/20 rounded-lg px-4 py-6 flex items-center justify-evenly max-w-xl ">
          ...
          <div className="w-1/2 flex justify-end items-start gap-y-25 flex-col">
            ...
            <button className="text-14px font-medium text-white bg-black px-3  p-1 rounded-lg">
              Get Unsplash+
            </button>
          </div>
          ...
          <div className="relative w-1/2">
            ...
            />
            {/* Chip 1 */}
            <div className="flex items-center justify-center gap-x-1 absolute z-10 top-32 left-20 border border-gray-200 rounded-full px-2 py-1 bg-white font-normal text-10px">
              <CircleCheck fill="green" className="text-white w-5 h-5" />
              Worry-free Licensing
            </div>
            {/* chip 2 */}
            <div className="flex items-center justify-centergap-x-1 absolute z-10 text-[12] bg-white border border-gray-200 px-2 py-1 rounded-full top-44 -left-6">
              <CircleCheck fill="green" className="text-white w-5 h-5" />
